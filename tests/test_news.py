...
def test_command_formats_briefing_in_persona(monkeypatch):
    ...
    assert "1. Meldung Eins — Beschreibung eins.\n" in result.message
...
<rss version="2.0"><channel>
  <title>"Usingen" - Google News</title>
  <item><title>Stadtfest abgesagt - Usinger Anzeiger</title><description>&lt;ol&gt;&lt;li&gt;&lt;a href="x"&gt;Link-Salat&lt;/a&gt;&lt;/li&gt;&lt;/ol&gt;</description></item>
  <item><title>Luftqualit\xc3\xa4t in Usingen: aktuelle Messwerte - wetter.de</title><description>junk</description></item>
...
def test_google_news_items_use_clean_title_and_publisher():
    ...
    assert heads[0].source == "Usinger Anzeiger"
...
def test_feed_title_slogan_is_trimmed_and_duplicate_summary_dropped():
    ...
    assert heads[2].title == "Merz verteidigt Reformvorhaben"
    assert heads[2].summary == ""  # Titel-Dublette weg
