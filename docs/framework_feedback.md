...
### FF-J-004 - Übergangsprinzip "Leitplanke vor Autonomie" gelebt

- Herkunftsprojekt: `jarvis`
- Konkreter Beleg: Der Commit-Status wurde am 2026-07-06 (Charter 1.3) von 🟡 (explizite Freigabe je Commit) auf 🟢 (autonomer Commit nach Arbeitspaket-Freigabe) angehoben - und zwar genau in dem Moment, als die mechanische Absicherung (Pre-Commit-Hook mit Gate + Vollsuite) vier bewährte Läufe hinter sich hatte. Nicht früher (Vertrauen ersetzt keine Leitplanke), nicht später (sonst bleibt die Handbremse Ritual). Review + PO-Freigabe blieben unverändert Pflicht; nur der mechanische Commit-Schritt wurde autonom.
- Vorgeschlagene Änderung: Das im Framework-Diskurs als Pattern-Kandidat vertagte Übergangsprinzip **"Leitplanke vor Autonomie"** (Autonomiestufen verschieben sich nicht durch Vertrauen, sondern durch mechanische Absicherung) hat mit diesem Vorgang einen ersten gelebten Datenpunkt. Kandidat für `patterns/process/` bei der nächsten Framework-Durchsicht.
