...
- `.docx`-Handbook als binäre, nicht diffbare SSoT: Umstieg auf ein diffbares Format (z. B. Markdown) erwägen - bewusst aufgeschoben (Ablenkung von der Nutzwert-Phase), aber als technische Schuld notiert.
