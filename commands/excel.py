...
im Command selbst - Letzteres übernimmt die read_excel-Lesefunktion (ADR-014),
...
def read_workbook_sheets(
    ...
    und die read_excel-Lesefunktion (ADR-014), damit die Lese-Logik nur an
...
class ReadExcelCommand:
    ...
    description = (
        ...
        "target = vollständiger Dateipfad (z. B. 'C:\\Daten\\tabelle.xlsx'). "
