...
# Abschieds-Varianten (Persona-Lebendigkeit, PO-Befund 2026-07-10) - alle
# enthalten "herunter" (stabiler Kern fuer Tests und Wiedererkennung).
_FAREWELLS = (
    "Wie du wünschst, Sir — ich fahre herunter. Bis bald.",
    "Sehr wohl, Sir — ich fahre herunter. Man sieht sich.",
    "In Ordnung, Sir — ich fahre herunter und bin außer Dienst.",
)
...
class StopRuntimeCommand:
    ...
    def execute(self, plan: Plan) -> Result:
        ...
        return Result(status=Status.SUCCESS, message=pick(*_FAREWELLS))
