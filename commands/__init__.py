...
def _register_all() -> None:
    from commands import delegate, excel, installer, mail, memory, monitor, reports, system, web

    for module in (system, memory, monitor, installer, excel, reports, mail, web, delegate):
