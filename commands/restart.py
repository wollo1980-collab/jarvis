...
# Neustart-Varianten (Persona-Lebendigkeit, PO-Befund 2026-07-10) - alle
# enthalten "neu" (stabiler Kern fuer Tests und Wiedererkennung).
_RESTART_LINES = (
    "Wie du wünschst, Sir — ich starte mich neu. Gleich wieder da.",
    "Sehr wohl, Sir — Neustart läuft. Einen Augenblick.",
    "In Ordnung, Sir — ich starte neu und bin gleich zurück.",
)
...
class RestartRuntimeCommand:
    ...
    def execute(self, plan: Plan) -> Result:
        ...
        return Result(status=Status.SUCCESS, message=pick(*_RESTART_LINES))
