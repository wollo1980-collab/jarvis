...
class Plan:
    ...
    # Merk-Angebot (ADR-051): vom Planner NEBENBEI erkannter dauerhafter
    # Fakt über den Nutzer. Löst NIE eine Speicherung aus - nur die
    # Rückfrage "Soll ich mir das merken?" (Vorschlag statt Aktion).
